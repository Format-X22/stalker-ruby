...
/* Generated by Opal 0.10.4 */
Opal.modules["js_auth"] = function(Opal) {
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  function $rb_lt(lhs, rhs) {
  ...
  Opal.add_stubs(['$[]', '$change', '$validate_login', '$validate_pass', '$sign', '$to_profile', '$modal', '$validate_mail', '$register', '$post', '$val', '$callback', '$hide_preloader', '$json', '$success', '$call', '$show_error_modal', '$message', '$handle_request_error', '$show_preloader', '$request', '$errback', '$href=', '$location', '$on', '$send', '$==', '$which', '$validate_field', '$>', '$length', '$<', '$>=', '$value', '$parent', '$children', '$add_class', '$remove_class', '$html']);
  return (function($base, $super) {
    function $JS_Auth(){};
    var self = $JS_Auth = $klass($base, $super, 'JS_Auth', $JS_Auth);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3, TMP_5, TMP_7, TMP_8, TMP_11, TMP_13, TMP_14, TMP_16, TMP_18, TMP_20, TMP_22, TMP_24, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30;

    def.login_top = def.pass_top = def.login_modal = def.pass_modal = def.login_register = def.pass_register = def.mail_register = def.preloader = def.error_body = def.error_modal = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      var self = this;

      self.login_top = $scope.get('Element')['$[]']("#login-top");
      self.pass_top = $scope.get('Element')['$[]']("#pass-top");
      self.$change(self.login_top, "validate_login");
      return self.$change(self.pass_top, "validate_pass");
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$sign_from_top', TMP_3 = function $$sign_from_top() {
      var $a, $b, TMP_2, self = this;

      if ((($a = ((($b = self.$validate_login(self.login_top)) !== false && $b !== nil && $b != null) ? $b : self.$validate_pass(self.pass_top))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      return ($a = ($b = self).$sign, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return self.$to_profile()}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($b, self.login_top, self.pass_top);
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$sign_from_modal', TMP_5 = function $$sign_from_modal() {
      var $a, $b, TMP_4, self = this;

      if ((($a = ((($b = self.$validate_login(self.login_modal)) !== false && $b !== nil && $b != null) ? $b : self.$validate_pass(self.pass_modal))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      return ($a = ($b = self).$sign, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

      $scope.get('Element')['$[]']("#sign-modal").$modal("hide");
        return self.$to_profile();}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($b, self.login_modal, self.pass_modal);
    }, TMP_5.$$arity = 0);

    Opal.defn(self, '$register_from_modal', TMP_7 = function $$register_from_modal() {
      var $a, $b, $c, TMP_6, self = this;

      if ((($a = ((($b = ((($c = self.$validate_login(self.login_register)) !== false && $c !== nil && $c != null) ? $c : self.$validate_pass(self.pass_register))) !== false && $b !== nil && $b != null) ? $b : self.$validate_mail(self.mail_register))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      return ($a = ($b = self).$register, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

      $scope.get('Element')['$[]']("#register-modal").$modal("hide");
        return self.$to_profile();}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b, self.login_register, self.pass_register, self.mail_register);
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$sign', TMP_8 = function $$sign(login, pass) {
      var $a, $b, TMP_9, self = this, $iter = TMP_8.$$p, callback = $iter || nil, request = nil;

      TMP_8.$$p = null;
      request = $scope.get('HTTP').$post("/api/sign-in", $hash2(["payload"], {"payload": $hash2(["login", "pass"], {"login": login.$val(), "pass": pass.$val()})}));
      ($a = ($b = request).$callback, $a.$$p = (TMP_9 = function(response){var self = TMP_9.$$s || this, $c, result = nil;
if (response == null) response = nil;
      self.$hide_preloader();
        result = response.$json();
        if ((($c = result.$success()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          return callback.$call()
          } else {
          return self.$show_error_modal(result.$message())
        };}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $a).call($b);
      return self.$handle_request_error(request);
    }, TMP_8.$$arity = 2);

    Opal.defn(self, '$register', TMP_11 = function $$register(login, pass, mail) {
      var $a, $b, TMP_10, self = this;

      self.$show_preloader();
      $scope.get('HTTP').$post("/api/register", $hash2(["payload"], {"payload": $hash2(["login", "pass", "mail"], {"login": login.$val(), "pass": pass.$val(), "mail": mail.$val()})}));
      ($a = ($b = self.$request()).$callback, $a.$$p = (TMP_10 = function(response){var self = TMP_10.$$s || this, $c, result = nil;
if (response == null) response = nil;
      self.$hide_preloader();
        result = response.$json();
        if ((($c = result.$success()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
      ...
      return self.$handle_request_error(self.$request());
    }, TMP_11.$$arity = 3);

    Opal.defn(self, '$handle_request_error', TMP_13 = function $$handle_request_error(request) {
      var $a, $b, TMP_12, self = this;

      return ($a = ($b = request).$errback, $a.$$p = (TMP_12 = function(response){var self = TMP_12.$$s || this;
if (response == null) response = nil;
      self.$hide_preloader();
        return self.$show_error_modal(response.$message());}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($b);
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$to_profile', TMP_14 = function $$to_profile() {
      var $a, $b, self = this;

      return (($a = ["/profile"]), $b = $scope.get('Window').$location(), $b['$href='].apply($b, $a), $a[$a.length-1]);
    }, TMP_14.$$arity = 0);

    Opal.defn(self, '$click', TMP_16 = function $$click(field, method_sym) {
      var $a, $b, TMP_15, self = this;

      return ($a = ($b = field).$on, $a.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

      return self.$send(method_sym, field)}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $a).call($b, "click");
    }, TMP_16.$$arity = 2);

    Opal.defn(self, '$enter_key', TMP_18 = function $$enter_key(field, method_sym) {
      var $a, $b, TMP_17, self = this;

      return ($a = ($b = field).$on, $a.$$p = (TMP_17 = function(event){var self = TMP_17.$$s || this;
if (event == null) event = nil;
      if (event.$which()['$=='](13)) {
          return self.$send(method_sym, field)
          } else {
          return nil
        }}, TMP_17.$$s = self, TMP_17.$$arity = 1, TMP_17), $a).call($b, "keypress");
    }, TMP_18.$$arity = 2);

    Opal.defn(self, '$change', TMP_20 = function $$change(field, method_sym) {
      var $a, $b, TMP_19, self = this;

      return ($a = ($b = field).$on, $a.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this;

      return self.$send(method_sym, field)}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19), $a).call($b, "change");
    }, TMP_20.$$arity = 2);

    Opal.defn(self, '$validate_login', TMP_22 = function $$validate_login(field) {
      var $a, $b, TMP_21, self = this;

      return ($a = ($b = self).$validate_field, $a.$$p = (TMP_21 = function(value){var self = TMP_21.$$s || this, $c;
if (value == null) value = nil;
      return ($c = $rb_gt(value.$length(), 2), $c !== false && $c !== nil && $c != null ?$rb_lt(value.$length(), 100) : $c)}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21), $a).call($b, field);
    }, TMP_22.$$arity = 1);

    Opal.defn(self, '$validate_pass', TMP_24 = function $$validate_pass(field) {
      var $a, $b, TMP_23, self = this;

      return ($a = ($b = self).$validate_field, $a.$$p = (TMP_23 = function(value){var self = TMP_23.$$s || this, $c;
if (value == null) value = nil;
      return ($c = $rb_ge(value.$length(), 8), $c !== false && $c !== nil && $c != null ?$rb_lt(value.$length(), 100) : $c)}, TMP_23.$$s = self, TMP_23.$$arity = 1, TMP_23), $a).call($b, field);
    }, TMP_24.$$arity = 1);

    Opal.defn(self, '$validate_mail', TMP_26 = function $$validate_mail(field) {
      var $a, $b, TMP_25, self = this;

      return ($a = ($b = self).$validate_field, $a.$$p = (TMP_25 = function(value){var self = TMP_25.$$s || this, $c;
if (value == null) value = nil;
      return ($c = $rb_ge(value.$length(), 6), $c !== false && $c !== nil && $c != null ?$rb_lt(value.$length(), 100) : $c)}, TMP_25.$$s = self, TMP_25.$$arity = 1, TMP_25), $a).call($b, field);
    }, TMP_26.$$arity = 1);

    Opal.defn(self, '$validate_field', TMP_27 = function $$validate_field(field) {
      var $a, self = this, $iter = TMP_27.$$p, cond = $iter || nil, val = nil, wrap = nil, feedback = nil;

      TMP_27.$$p = null;
      val = field.$value();
      wrap = field.$parent(".form-group");
      feedback = wrap.$children(".form-control-feedback");
      if ((($a = cond.$call(val)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defn(self, '$show_preloader', TMP_28 = function $$show_preloader() {
      var self = this;

      return self.preloader.$remove_class("hidden");
    }, TMP_28.$$arity = 0);

    Opal.defn(self, '$hide_preloader', TMP_29 = function $$hide_preloader() {
      var self = this;

      return self.preloader.$add_class("hidden");
    }, TMP_29.$$arity = 0);

    return (Opal.defn(self, '$show_error_modal', TMP_30 = function $$show_error_modal(text) {
      var $a, $b, self = this;

      if ((($a = ((($b = text['$==']("")) !== false && $b !== nil && $b != null) ? $b : text['$=='](nil))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        text = "Неизвестная ошибка..."};
      self.error_body.$html(text);
      return self.error_modal.$modal("show");
    }, TMP_30.$$arity = 1), nil) && 'show_error_modal';
  })($scope.base, null)
};
...
(function(Opal) {
  ...
  self.$require("js_auth.rb");
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

  return $scope.get('JS_Auth').$new()}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
